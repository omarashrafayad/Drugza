    ...
    <div className="flex flex-col sm:flex-row items-center justify-center p-4 gap-4">
      <div className="flex items-center justify-center gap-1 md:gap-2 flex-none">
        <Button
          ...
          className="w-8 h-8"
        >
          <ChevronLeft className={`w-4 h-4 ${typeof document !== 'undefined' && document?.dir === 'rtl' ? 'rotate-180' : ''}`} />
        </Button>
        ...
        <Button
          ...
          className="w-8 h-8"
        >
          <ChevronRight className={`w-4 h-4 ${typeof document !== 'undefined' && document?.dir === 'rtl' ? 'rotate-180' : ''}`} />
        </Button>
      </div>
