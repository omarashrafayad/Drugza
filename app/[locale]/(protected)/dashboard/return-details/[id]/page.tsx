...
const ReturnDetails = () => {
  ...
  const { loading: updating, updateReturnStatus } =
  ...
  const handleUpdateReturnStatus = async () => {
    ...
    try {
      const statusValue =
        statusReverseMap[selectedStatus] ?? 0;
                    ...
                    <SelectValue placeholder="Select status">
                      <div className="flex items-center gap-2">
                        <Icon
                          ...
                          className={`h-4 w-4 ${currentStatus.iconClass}`}
                        />
        ...
        <CardHeader className="border-0">
          <div className="flex justify-between flex-wrap gap-4 items-center">
            <div className="w-full">
              <span className="block text-default-900 font-medium text-xl mb-4">
                Return Details
              </span>
                  ...
                  returnData.items.map(
                    (
                      ...
                      return (
                        <div
                          key={index}
                          className="mt-4 p-4 border border-gray-200 rounded bg-gray-50 space-y-1"
                        >
                          <div>
                          ...
                          <div>
                            ...
                            {item.productPrice
                              ...
                              : `$${returnData.totalReturnValue?.toFixed(
                                  2
                                )}`}
                          </div>
